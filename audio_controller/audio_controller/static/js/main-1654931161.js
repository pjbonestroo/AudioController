...
// Transcrypt'ed from Python, 2022-06-11 09:05:56
...
// Transcrypt'ed from Python, 2022-06-11 09:05:58
...
// Transcrypt'ed from Python, 2022-06-11 09:05:57
...
var TestDebug =  __class__ ('TestDebug', [AccordionItem], {
	...
	get __init__ () {return __get__ (this, function (self) {
		...
		self.button_test_gpio = pages_page_admin_E ('button').attr ('class', 'btn btn-primary btn-sm').inner_html ('Test GPIO');
		var buttons = [self.button_reboot, self.button_shutdown, self.button_show_ip, self.button_show_routes, self.button_download_log, self.button_test_gpio];
	...
	get test_gpio () {return __get__ (this, async function (self, evt) {
		self.button_test_gpio.disable ();
		var txt = await pages_page_admin_utils.post (pages_page_admin_utils.get_url ('general/test_gpio'), dict ({}), false);
...
var Select =  __class__ ('Select', [ElementWrapper], {
...
var pages_page_psalmbord_Page =  __class__ ('Page', [ElementWrapper], {
	...
	get __init__ () {return __get__ (this, function (self) {
		...
		self.psalmbord = null;
		var input_title = pages_page_psalmbord_E ('input').attr ('class', 'form-control').attr ('type', 'text');
		var width_1 = 'col-sm-2';
		var width_2 = 'col-sm-3';
		self.append (pages_page_psalmbord_E ('div').attr ('class', 'form-group row').append (pages_page_psalmbord_E ('label').attr ('class', '{} col-form-label'.format (width_1)).inner_html ('Titel'), pages_page_psalmbord_E ('div').attr ('class', '{}'.format (width_2)).append (input_title)));
		var div_list = pages_page_psalmbord_E ('div');
		...
		self.append (pages_page_psalmbord_E ('div').attr ('style', 'min-height: 2vh;'));
		...
		self.append (pages_page_psalmbord_E ('div').attr ('class', 'form-group row').append (pages_page_psalmbord_E ('label').attr ('class', '{} col-form-label'.format (width_1)).inner_html ('Letter type'), pages_page_psalmbord_E ('div').attr ('class', '{}'.format (width_2)).append (select_fontfamily)), pages_page_psalmbord_E ('div').attr ('class', 'form-group row').append (pages_page_psalmbord_E ('label').attr ('class', '{} col-form-label'.format (width_1)).inner_html ('Letter grootte'), pages_page_psalmbord_E ('div').attr ('class', '{}'.format (width_2)).append (select_fontsize)), pages_page_psalmbord_E ('div').attr ('class', 'form-group row').append (pages_page_psalmbord_E ('label').attr ('class', '{} col-form-label'.format (width_1)).inner_html ('Letter dikte'), pages_page_psalmbord_E ('div').attr ('class', '{}'.format (width_2)).append (select_fontweight)));
		var initialize = async function () {
...
// Transcrypt'ed from Python, 2022-06-11 09:05:59
